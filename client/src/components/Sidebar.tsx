  ...
  return (
    ...
    >
      <div className="p-5 border-b border-gray-700">
        <h2 className="text-xl font-heading font-bold">CARS MOTION</h2>
      ...
      <div className="mt-auto p-5 border-t border-gray-700">
        <button 
          ...
          className="w-full bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-md transition duration-200 flex items-center justify-center"
        >
